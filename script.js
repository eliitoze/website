  ...
  if (summaryContainer) {
    ...
    summaryContainer.innerHTML = `
      <div class="cart-summary">
        ...
        <div class="summary-row"><span>Shipping</span><span>${remaining <= 0 ? '<span style="color:var(--green);font-weight:700;">FREE</span>' : '<span style="color:#888;">See above</span>'}</span></div>
